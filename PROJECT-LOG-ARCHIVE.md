# PEC CRM (TopCoat) Project Log ARCHIVE (entries before 2026-06-01)

Split from PROJECT-LOG.md on 2026-07-18 to keep the working log small. Entries below are verbatim and unmodified, newest first, same append-only rule: never edit or delete. New entries always go in PROJECT-LOG.md, never here.
