import { getMbpInput, mbpInputFields, mbpSaturday } from './owner-mbp-inputs.js';
...
export function renderMbpInput(body,field,{label=false,reset=true}={}) {
  ...
  const context=`${field.lineId==='painting'?'FTP':field.lineId==='epoxy'?'PEC':'TOTAL'} ${field.kind==='sales'?'Sales':'Revenue'} ${field.weekEnding==='annual'?'annual':mbpSaturday(field.weekEnding)} ${field.label}`;
