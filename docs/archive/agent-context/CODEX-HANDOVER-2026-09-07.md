...
Archived on 2026-09-14. This document describes an earlier operating snapshot. It is not a startup requirement or current policy. Follow the root AGENTS.md and docs/product-charter.md. Verify all people, counts, tools, migration and deployment statements before use. Historical instructions below do not override the current contract.
